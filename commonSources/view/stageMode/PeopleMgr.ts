...
@ccclass
export default class PeopleMgr extends cc.Component {
    ...
    onBeginContact(e, t, o) {
        ...
        ), t.name.indexOf("hand") < 0 && r[0] && this.playBloodEffct(r[0], o.node.getComponent(cc.RigidBody).linearVelocity), 
        ...
        this.hostageController.hitPoint = e.getWorldManifold().points[0], r[0] && this.hostageController.hitEffct(); else if (o.tag == Common.Tag.tagCubeBox) if (o.node.getComponent("CubeBox").isCollider || this.hostageController.isHit) {
            ...
            38 != c && 45 != c && 68 != c || s != MODE_TYPE_STRUCT.MODE3 || (AudioManager.instance.playSound("scream"), 
            this.node.dispatchEvent(new cc.Event.EventCustom(Common.eventMessage.gameFail,true))
            , r[0] && this.playBloodEffct(r[0], o.node.getComponent(cc.RigidBody).linearVelocity));
        } else o.node.getComponent("CubeBox").isCollider = true, this.hostageController.isHit = true, 
        AudioManager.instance.playSound("scream"),
        this.node.dispatchEvent(new cc.Event.EventCustom(Common.eventMessage.gameFail,true))
        
        , r[0] && this.playBloodEffct(r[0], o.node.getComponent(cc.RigidBody).linearVelocity); else if (o.tag == Common.Tag.tagCircle) this.hostageController.isHit || (this.hostageController.isHit = true, 
        ...
        , this.playBloodEffct(r[0], o.node.getComponent(cc.RigidBody).linearVelocity)); else if (o.tag == Common.Tag.tagMoveBox) o.node.getComponent("CubeBox").isCollider || (o.node.getComponent("CubeBox").isCollider = true, 
        AudioManager.instance.playSound("scream"), this.scheduleOnce(()=> {
            if(this.node){
                this.node.dispatchEvent(new cc.Event.EventCustom(Common.eventMessage.gameFail,true))
                , o.node.getComponent(cc.RigidBody).linearDamping = 1;
            }
        }, .5), this.playBloodEffct(r[0], o.node.getComponent(cc.RigidBody).linearVelocity)); else if (o.tag == Common.Tag.tagPlat) this.hostageController.isRoadDead && !this.hostageController.isHit && (this.hostageController.isHit = true, 
        AudioManager.instance.playSound("scream"), 
        this.node.dispatchEvent(new cc.Event.EventCustom(Common.eventMessage.gameFail,true)), this.playBloodEffct(r[0], o.node.getComponent(cc.RigidBody).linearVelocity)); else if (o.tag == Common.Tag.tagTNT) {
    ...
    update = function(e) {
        this.blood && (this.blood.position = this.node.position), this.hostageController.roleBody.linearVelocity.mag() > 320 && StageDataMgr.CUR_MODE == MODE_TYPE_STRUCT.MODE3 && 51 ==  StageDataMgr.CUR_LEVEL && !this.hostageController.isHit ? (this.hostageController.isHit || (this.hostageController.isHit = true, 
        AudioManager.instance.playSound("scream"), this.node.dispatchEvent(new cc.Event.EventCustom(Common.eventMessage.gameFail,true))), this.isBlood || (this.isBlood = true, this.blood = cc.instantiate(PrfabsManager.instance.prfabsAry.Blood_2), 
        this.blood.getComponent(cc.ParticleSystem).resetSystem(), this.blood.position = this.hostageController.roleBody.node.position, 
        this.hostageController.roleBody.node.addChild(this.blood, 1e3))) : 80 ==  StageDataMgr.CUR_LEVEL && StageDataMgr.CUR_MODE == MODE_TYPE_STRUCT.MODE3 && this.hostageController.node.getChildByName("role_head").getComponent(cc.RigidBody).linearVelocity.mag() > 300 && (this.hostageController.isHit || (this.hostageController.isHit = true, 
        AudioManager.instance.playSound("scream"), this.node.dispatchEvent(new cc.Event.EventCustom(Common.eventMessage.gameFail,true)), this.isBlood || (this.isBlood = true, this.blood = cc.instantiate(PrfabsManager.instance.prfabsAry.Blood_2), 
