...
function() {
    ...
    function e() {
        ...
        this.onStart = function(a) {
            if (e(a)) {
                ...
                o.snm = a.stageName,
                o.state = "start",
                n = "" + Date.now() + Math.floor(1e7 * Math.random()),
                t = o,
                ("string" === s(a.userId) && a.userId) < 32 && (this.uid = a.uid),
                this.request()
            }
        },
        this.onRunning = function(n) {
            if (e(n)) {
                ...
                if (r.event = n.event, "object" === s(n.params)) {
                    ...
                    r.params.itnm = n.params.itemName,
                    "string" === s(n.params.itemId) && n.params.itemId.length < 32 && (r.params.itid = n.params.itemId),
        ...
        this.onEnd = function(n) {
            if (e(n)) {
                ...
                a.snm = n.stageName,
                a.event = n.event,
                a.sdr = 0 !== r ? Date.now() - r: "",
                a.params = {},
                "object" === s(n.params) && "string" === s(n.params.desc) && n.params.desc.length < 64 && (a.params.desc = n.params.desc),
                t = a,
                this.request()
            }
        },
            ...
            wx.getSetting({
                success: function(t) {
                    t.authSetting["scope.userInfo"] ? wx.getUserInfo({
                        success: function(t) {
                            O = f(t.userInfo.avatarUrl.split("/")),
                            e(t)
                        },
                        fail: function() {
                            e("")
    ...
    function i() {
        ...
        this.next = function() {
            e.activeCount--,
            e.queue.length > 0 && e.queue.shift()()
        }
    }
    function c(e, t) {
        function n() {
    ...
    function f(e) {
        for (var t = "",
        n = 0; n < e.length; n++) e[n].length > t.length && (t = e[n]);
        return t
    }
    var l = "2.0.0",
    h = "glog",
    g = require("./ald-game-conf");
    "" === g.app_key && console.error("请在配置文件中填写您的app_key"),
    g.app_key = g.app_key.replace(/\s/g, ""),
    function() {
        wx.request({
    ...
    function() {
        ...
        "" !== e[2] ? (v.lat = e[2].latitude || "", v.lng = e[2].longitude || "", v.spd = e[2].speed || "") : (v.lat = "", v.lng = "", v.spd = ""),
        "" !== e[1] ? v.nt = e[1].networkType || "": v.nt = "";
        var t = d(v);
        "" !== e[0] && (t.ufo = e[0], k = e[0]),
        c(t, "init")
    }),
    wx.onShow(function(e) {
        ...
        n = d(v);
        t.sm = M - q,
        e.query.ald_share_src && e.shareTicket && "1044" === e.scene ? (n.tp = "ald_share_click", r().then(function(e) {
            n.ct = e,
            c(n, "event")
    ...
    var P = {
        ...
        aldOnShareAppMessage: function(e) {
            wx.onShareAppMessage(function() {
                ...
                "undefined" != s(t.ald_desc) && (n += "&ald_desc=" + t.ald_desc),
                t.query = n;
                var r = d(v);
                return r.ct = t,
                r.ct.sho = 1,
                r.tp = "ald_share_chain",
                c(r, "event"),
                t
            })
        },
    ...
    try {
        ...
        v.sv = A.system,
        v.wvv = A.platform,
        v.fs = A.fontSizeSetting,
        v.wsdk = A.SDKVersion,
        v.bh = A.benchmarkLevel || "",
        v.bt = A.battery || "",
        v.wf = A.wifiSignal || "",
        v.lng = "",
        v.lat = "",
