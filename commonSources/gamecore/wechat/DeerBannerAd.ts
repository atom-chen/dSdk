...
export default class DeerBannerAd extends WXBannerAdBase {
    ...
    public relayout(): void {
        ...
        this._adRect = {"x":0, "y":0, "width":0, "height":0};
        this._adRect.x = adX - adNode.width * adScale / 2 - this.borderWeight;
        this._adRect.y = adY - adNode.height * adScale / 2 - this.borderWeight;
        this._adRect.width = adNode.width * adScale + this.borderWeight * 2;
        this._adRect.height = adNode.height * adScale + this.borderWeight * 2;
